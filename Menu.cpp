...
void Menu:: open_file(int argc, char** argv)
{
    ...
    if(utf8::is_valid(temp.begin(),temp.end())== false ) throw 1; ///< Sprawdzamy za pomocą funkcji bibliotecznej czy rzeczywiście mamy doczynenia z plikiem zakodowanym w UTF-8
}
